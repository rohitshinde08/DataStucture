#include<stdio.h>
#define MAX 10
int vis[MAX]={0},stack[MAX],top=-1,adj[MAX][MAX];
void dfs(int start,int vr)
{
     int i;
     vis[start]=1;
     printf(" %d ",start+1);
...
void main()
{
     ...
     scanf("%d",&start);
     printf("\nDepth First Search Traversal Of UnDirected Graph :\n");
     dfs(start-1,v);
}
...
Enter Number Of Vertices For Undirected Graph : 6
